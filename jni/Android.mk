...
LOCAL_CFLAGS := -iquote $(LOCAL_PATH)/../ -iquote $(LOCAL_PATH)/../kernel/ \
-iquote $(LOCAL_PATH)/../rdft/ -iquote $(LOCAL_PATH)/../dft/ \
-iquote $(LOCAL_PATH)/../reodft/ -iquote $(LOCAL_PATH)/../dft/scalar/ \
-iquote $(LOCAL_PATH)/../rdft/scalar/
