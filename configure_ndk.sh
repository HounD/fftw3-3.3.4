...
./configure -host=arm-linux-androideabi \
            ...
            CPPFLAGS="-I$NDK/platforms/$ANDROID_API_LEVEL/arch-arm/usr/include/" \
            CFLAGS="-nostdlib" \
            LDFLAGS="-Wl,-rpath-link=$NDK/platforms/$ANDROID_API_LEVEL/arch-arm/usr/lib/ -L$NDK/platforms/$ANDROID_API_LEVEL/arch-arm/usr/lib/" \
            LIBS="-lc" \
            --disable-fortran \
            --disable-alloca \
#	    --enable-single \
